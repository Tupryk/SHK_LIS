...
class ManipulationModelling():
    ...
    def setup_pick_and_place_waypoints(self,
                                       gripper: str,
                                       obj: str,
    ...
    def setup_point_to_point_motion(self,
                                    q0: list,
                                    q1: list,
                                    homing_scale: float=1e-2,
                                    acceleration_scale: float=1e-1,
                                    accumulated_collisions: bool=True,
                                    quaternion_norms: bool=False):
        """
    ...
    def setup_point_to_point_rrt(self, q0: list, q1: list, explicitCollisionPairs: list):
        rrt = ry.PathFinder()
    ...
    def straight_push(self, times: list, obj: str, gripper: str, table: str):
    ...
    def pull(self, times: list, obj: str, gripper: str, table: str):
    ...
    def follow_path_on_plane(self, path: list, moving_frame: str, plane: str="z"):
        """
    ...
    def path_must_be_straight(self, times: str, start_frame: str, end_frame: str, moving_frame: str, gotoPoints: bool=False):
        """
    ...
    def keep_distance(self, time_interval: list, obj1: str, obj2: str, margin: float=.001):
        """
    ...
    def keep_dist_pairwise(self, time_interval: list, objs_lst1: list, margin: float=0.001):
        """
    ...
    def switch_place():
        ...
        """
    def target_position(self, time: float, obj: str, pos: list):
        """
    ...
    def target_relative_xy_position(self, time: float, obj: str, relativeTo: str, pos: list):
        """
        impose a specific 3D target position on some object
        """
        if len(pos)==2:
    ...
    def bias(self, time: float, qBias: list, scale: float=1e0):
        """
    ...
    def retract(self, time_interval: list, gripper: str, dist: float=.05):
    ...
    def approach(self, time_interval: list, gripper: str, dist: float=.05):
    ...
    def retractPush(self, time_interval: list, gripper: str, dist: float):
        helper = f'_{gripper}_start'
    ...
    def approachPush(self, time_interval: list, gripper: str, dist: float):
    ...
    def sub_rrt(self, phase: int, explicitCollisionPairs: list=[]):
        (C, q0, q1) = self.komo.getSubProblem(phase)
    ...
    # Debug functions
    def fetch_name_error_type(self, data: dict):
