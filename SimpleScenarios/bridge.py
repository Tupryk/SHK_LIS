...
def maneuverTo(C, bot, block):
    ...
    komo.addObjective([4], ry.FS.positionDiff, ['l_gripper', f'{block}way4'], ry.OT.eq, [1e1], [.1])
    ...
    bot.move(np.asarray([C.getJointState(), q[-1]]), [2])  # save last pathstep for after loslassing
